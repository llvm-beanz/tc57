...
character, and is not consistent with C or C++ language styling, and is
ambiguous against C preprocessor tokens. This causes technical challenges by
using reserved preprocessor tokens, but also makes the feature foreign and less
approachable in a C-like language.
