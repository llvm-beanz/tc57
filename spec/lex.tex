...
\begin{grammar}
  ...
  \terminal{inline inout int line lineadj linear namespace nointerpolation}\br
  \terminal{noperspective operator out packoffset payload point precise}\br
  \terminal{primitives reordercoherent return row\_major sizeof}\br
  \terminal{snorm static struct switch tbuffer template this triangle}\br
  \terminal{triangleadj true typedef typename unorm unsigned using vertices}\br
  \terminal{void while}
\end{grammar}
